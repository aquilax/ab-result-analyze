...
var _abResult = __webpack_require__(7);
...
var AbResultView = function (_Backbone$View$extend) {
    _inherits(AbResultView, _Backbone$View$extend);

    function AbResultView() {
        _classCallCheck(this, AbResultView);

        return _possibleConstructorReturn(this, (AbResultView.__proto__ || Object.getPrototypeOf(AbResultView)).apply(this, arguments));
    }

    _createClass(AbResultView, [{
        key: 'initialize',
...
var AppView = function (_Backbone$View$extend3) {
    _inherits(AppView, _Backbone$View$extend3);
    ...
    _createClass(AppView, [{
        ...
        value: function onClickProcess() {
            ...
            var result = (0, _abResult2.default)(text);
